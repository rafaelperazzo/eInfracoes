...
def process_frame(frame_number, frame, bg_subtractor, car_counter):
	...
	#save_frame(IMAGE_DIR + "/imagens"+ "/mask_%04d.png" , frame_number, fg_mask, "foreground mask for frame #%d")
...
def main():
    ...
    while True:
        ...
        save_frame(IMAGE_DIR + "/imagens"+ "/processed_%04d.png"
